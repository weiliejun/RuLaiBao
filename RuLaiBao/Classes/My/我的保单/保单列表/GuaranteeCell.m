...
- (void)createCell{
    ...
    productNameLabel.text = @"国华人寿-盛世年年年金保险C款";
    ...
    customerNameLabel.text = @"客户姓名：王某某";
...
- (void)setGuaranteeListModelWithDictionary:(GuaranteeListModel *)model{
    //保险名称
