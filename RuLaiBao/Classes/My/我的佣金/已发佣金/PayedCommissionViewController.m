//
//  PayedCommissionViewController.m
//  RuLaiBao
//
...
@interface PayedCommissionViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation PayedCommissionViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"已发佣金";
    ...
    [tableView QLExtensionLoading:^{
        //进行请求数据
        self.page = 1;
        [self requestPayedCommissionDataWithPage:self.page];
    }];
...
#pragma mark - 请求已发佣金数据
- (void)requestPayedCommissionDataWithPage:(NSInteger)page {
    ...
    WeakSelf
    [[RequestManager sharedInstance]postUnpayCommissionWithUserId:[StoreTool getUserID] commissionStatus:@"yes" page:page Success:^(id responseData) {
        StrongSelf
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setPayedModelWithDictionary:self.infoArr[indexPath.section]];
