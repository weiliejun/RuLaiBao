...
@interface CommissionDetailViewController ()<UIScrollViewDelegate>
...
- (void)createUI {
    ...
    NSString *moneyStr = [[ChangeNumber alloc]changeNumber:self.infoDict[@"commissionGained"]];
    moneyLabel.text = [NSString stringWithFormat:@"+%@",moneyStr];
    ...
    //11>推广费
    DetailLabel *popularizeFeeLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(10, giveMoneyValueLabel.bottom+20, 55, 20) text:@"推广费:" fontSize:16 textColor:[UIColor customTitleColor]];
    ...
    //12>个人所得税
    DetailLabel *taxLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(10, popularizeFeeValueLabel.bottom+20, 88, 20) text:@"个人所得税:" fontSize:16 textColor:[UIColor customTitleColor]];
    taxLabel.textAlignment = NSTextAlignmentRight;
    [scrollView addSubview:taxLabel];
    NSString *taxStr = [NSString stringWithFormat:@"%@元",self.infoDict[@"individualTax"]];
    DetailLabel *taxValueLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(taxLabel.right+5, popularizeFeeValueLabel.bottom+20,  Width_Window-taxLabel.right-20, 20) text:taxStr fontSize:16 textColor:[UIColor customTitleColor]];
    [scrollView addSubview:taxValueLabel];
    //13>增值税
    DetailLabel *increaseTaxLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(10, taxValueLabel.bottom+20, 55, 20) text:@"增值税:" fontSize:16 textColor:[UIColor customTitleColor]];
    increaseTaxLabel.textAlignment = NSTextAlignmentRight;
    [scrollView addSubview:increaseTaxLabel];
    NSString *increaseTaxStr = [NSString stringWithFormat:@"%@元",self.infoDict[@"valueaddedTax"]];
    DetailLabel *increaseTaxValueLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(increaseTaxLabel.right+5, taxValueLabel.bottom+20,  Width_Window-increaseTaxLabel.right-20, 20) text:increaseTaxStr fontSize:16 textColor:[UIColor customTitleColor]];
    [scrollView addSubview:increaseTaxValueLabel];
    //14>附加税
    DetailLabel *surchargeLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(10, increaseTaxValueLabel.bottom+20, 55, 20) text:@"附加税:" fontSize:16 textColor:[UIColor customTitleColor]];
    surchargeLabel.textAlignment = NSTextAlignmentRight;
    [scrollView addSubview:surchargeLabel];
    NSString *surchargeStr = [NSString stringWithFormat:@"%@元",self.infoDict[@"additionalTax"]];
    DetailLabel *surchargeValueLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(surchargeLabel.right+5, increaseTaxValueLabel.bottom+20,  Width_Window-surchargeLabel.right-20, 20) text:surchargeStr fontSize:16 textColor:[UIColor customTitleColor]];
    [scrollView addSubview:surchargeValueLabel];
    //15>获得佣金
    DetailLabel *getCommissionLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(10, surchargeValueLabel.bottom+20, 70, 20) text:@"获得佣金:" fontSize:16 textColor:[UIColor customTitleColor]];
    ...
    DetailLabel *getCommissionValueLabel = [[DetailLabel alloc]initWithFrame:CGRectMake(getCommissionLabel.right+5, surchargeValueLabel.bottom+20,  Width_Window-getCommissionLabel.right-20, 20) text:getCommissionStr fontSize:16 textColor:[UIColor customTitleColor]];
...
- (void)requestTradeDetailData{
    WeakSelf
    [[RequestManager sharedInstance]postCommissionDetailWithId:self.Id Success:^(id responseData) {
