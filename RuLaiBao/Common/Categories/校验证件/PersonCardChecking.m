...
@implementation PersonCardChecking
...
//6. 出生年份的前两位必须是19或20/Users/kingstartimes/Desktop/未命名文件夹
...
//    value = [value stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
//    if ([PersonCardChecking verifyText:value withRegex:s1]) {
//        NSString *s11 = @"^\\d{4,20}$";
...
//{
//    NSString *birtday = [PersonCardChecking getIDCardBirthday:card];   //****年**月**日
//    //转换为****-**-**
