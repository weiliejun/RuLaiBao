...
/**
 The header view of search view 整个bgview
 */
...
@property (nonatomic, weak) UIView *hotSearchTagsComContentView;
...
- (void)setup
{
    ...
    UILabel *titleStrLabel = [self setupTitleLabel:[NSBundle py_localizedStringForKey:PYSearchHotSearchText]];
    self.hotSearchComHeader = titleStrLabel;
    [hotSearchView addSubview:titleStrLabel];
    //热搜的contentView
    UIView *hotSearchTagsComContentView = [[UIView alloc] init];
    hotSearchTagsComContentView.py_width = hotSearchView.py_width;
    hotSearchTagsComContentView.py_y = CGRectGetMaxY(titleStrLabel.frame) + PYSEARCH_MARGIN;
    hotSearchTagsComContentView.autoresizingMask = UIViewAutoresizingFlexibleWidth;
    [hotSearchView addSubview:hotSearchTagsComContentView];
    
    [headerView addSubview:hotSearchView];
    self.hotSearchTagsContentView = hotSearchTagsContentView;
    self.hotSearchTagsComContentView = hotSearchTagsComContentView;
