...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *addGuaranteeItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"add_Guarantee"] style:UIBarButtonItemStylePlain target:self action:@selector(toAddGuarantee)];
     self.navigationItem.rightBarButtonItem = addGuaranteeItem;
...
//增加保单
- (void)toAddGuarantee{
    GuaranteeAddViewController *addGuaranteeVC = [[GuaranteeAddViewController alloc]init];
    [self.navigationController pushViewController:addGuaranteeVC animated:YES];
}
