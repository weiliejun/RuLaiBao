...
- (void)customUI{
    ...
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 5, Width_Window-40, 35)];
    titleLabel.textColor = [UIColor customNavBarColor];
    titleLabel.textAlignment = NSTextAlignmentLeft;
    titleLabel.font = [UIFont systemFontOfSize:17];
    [self.contentView addSubview:titleLabel];
    
    UILabel *detailLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, titleLabel.bottom, Width_Window-40, 24)];
