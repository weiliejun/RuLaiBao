...
-(void)postGuaranteeAddUserId:(NSString *)userId PolicyHolder:(NSString *)policyHolder OrderCode:(NSString *)orderCode Success:(SuccessBlock)mysuccess Error:(ErrorBlock)myerror{
    NSString *jsonInput = [NSString stringWithFormat:@"{\"orderCode\":\"%@\",\"policyHolder\":\"%@\",\"userId\":\"%@\"}",orderCode,policyHolder,userId];
    //加密的签名
    NSString *md5str = [jsonInput VJK_md5String];
    NSString *lowermd5str = [md5str lowercaseString];
    NSString *jsonInputstr = [NSString stringWithFormat:@"{\"check\":\"%@\",\"data\":%@}",lowermd5str,jsonInput];
    ...
    NSString *Des3str = [DES3Util encrypt:jsonInputstr];
    NSDictionary *dict = [NSDictionary dictionaryWithObject:Des3str forKey:@"requestKey"];
    NSString *urlstr = [NSString stringWithFormat:@"%@://%@%@",DataHttp,RequestHeader,@"/account/order/tianan/add"];
