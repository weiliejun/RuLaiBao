...
#define QLDefaultMenuSeparatorMargin        6.0f
#define QLDefaultMenuSeparatorColor         [UIColor lightGrayColor]
#define QLDefaultBackgroundViewColor        [UIColor colorWithWhite:0.5 alpha:0.1f]
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.bottomBackgroundViewColor = QLDefaultBackgroundViewColor;
        self.menuSeparatorMargin = QLDefaultMenuSeparatorMargin;
        self.menuSeparatorColor = QLDefaultMenuSeparatorColor;
    }
    return self;
}
...
-(UITableView *)menuTableView
{
    if (!_menuTableView) {
        ...
        _menuTableView.separatorColor = [FTPopOverMenuConfiguration defaultConfiguration].menuSeparatorColor;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == _menuStringArray.count-1) {
        ...
        menuCell.separatorInset = UIEdgeInsetsMake(0, [FTPopOverMenuConfiguration defaultConfiguration].menuSeparatorMargin, 0, [FTPopOverMenuConfiguration defaultConfiguration].menuSeparatorMargin);
    }
    return menuCell;
}
...
-(UIView *)backgroundView
{
    if (!_backgroundView) {
        ...
        _backgroundView.backgroundColor = [FTPopOverMenuConfiguration defaultConfiguration].bottomBackgroundViewColor;
    }
