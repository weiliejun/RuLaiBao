...
@property (nonatomic, assign) CGFloat menuSeparatorMargin;//Default is 6. -- QL
@property (nonatomic, strong) UIColor *menuSeparatorColor;//---QL
@property (nonatomic, strong) UIColor *bottomBackgroundViewColor;//最底层的color  ---QL
/**
